...
//               tagWordModel = null;
//               bool isWrong = pageLines[x][j].word_id == '22150' && pageLines[x][j].ayaId == '989';
//               return GetBuilder<WordTagController>(builder: (_) {
...
//                       isWrong
//                           // ? 'عليكم'
//                           // ? const HtmlEscape(HtmlEscapeMode.element).convert('&#x639; &#x644; &#x649; &#x643; &#x645;')
//                           ? HtmlUnescape()
//                               .convert('&#x639;&#x64E;&#x644;&#x64E;&#x64A;&#x652;&#x643;&#x64F;&#x645;&#x652;')
...
//                       textScaleFactor: 1.0,
//                       style: TextStyle(
//                           fontFamily: isWrong ? null : 'p${widget.page}',
//                           fontSize: isWrong ? fontSize - 2 : fontSize,
//                           color: pageLines[x][j].ayaId == searchResultId.value.toString() ||
//                                   pageLines[x][j].ayaId == Get.find<ReadAyaController>().ayaId.toString()
//                               ? Colors.blue
//                               : SearchAyahData.wordsId.contains(int.parse(pageLines[x][j].word_id ?? '0'))
//                                   ? Colors.green
//                                   : _getTagId(pageLines[x][j]) == null
//                                       ? selectedAyaId.value == pageLines[x][j].ayaId!
//                                           // ? pr(readWordsColor, 'readWordsColor')
//                                           ? const Color(0xff000000)
//                                           : const Color(0xff000000)
//                                       : _getTagColor(pageLines[x][j]),
...
//                     tagId: pr(_getTagId(pageLines[x][j]).toString(), '$_t - tagId '),
...
//                 Get.find<ReadAyaController>()
//                     .playAyaById(int.parse(pageLines[x][j].ayaId ?? '0'), int.parse(pageLines[x][j].sura ?? '0'));
//               }
//               if (action == ShareOrReadAction.share) {
//                 String ayahAr = await DataBaseHelper.dataBaseInstance()
//                     .getAyaTextArByAyaId(int.parse(pageLines[x][j].ayaId ?? '0'));
...
//   String? _getTagId(WordModel wordModel) {
//     try {
...
//   @override
//   Widget build(BuildContext context) {
//     bool isWrong = wordModel.word_id == '22150' && wordModel.ayaId == '989';
//     return Container(
//       // margin: const EdgeInsets.only(right: 20),
//       child: Text(
//         isWrong
//             // ? 'عليكم'
//             // ? const HtmlEscape(HtmlEscapeMode.element).convert('&#x639; &#x644; &#x649; &#x643; &#x645;')
//             ? HtmlUnescape().convert('&#x639;&#x64E;&#x644;&#x64E;&#x64A;&#x652;&#x643;&#x64F;&#x645;&#x652;')
//             : HtmlUnescape().convert(wordModel.word_ar!),
//         // : '',
//         // const HtmlEscape(HtmlEscapeMode.element).convert(pageLines[x][j].word_ar!),
//         textAlign: TextAlign.justify,
//         textScaleFactor: 1.0,
//         style: TextStyle(
//             fontFamily: isWrong ? null : 'p$fontFamilyNum',
//             fontSize: isWrong ? fontSize - 2 : fontSize,
//             color: wordModel.ayaId == searchResultId.value.toString() ||
//                     wordModel.ayaId == Get.find<ReadAyaController>().ayaId.toString()
//                 ? Colors.blue
//                 : SearchAyahData.wordsId.contains(int.parse(wordModel.word_id ?? '0'))
//                     ? Colors.green
//                     : _getTagId(wordModel) == null
